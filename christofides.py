#This code adapted from the Christofides implementation of Retsediv: https://github.com/Retsediv/ChristofidesAlgorithm/blob/master/christofides.py
    ...
    for this in range(len(data)):
        for another_point in range(len(data)):
            if this != another_point:
                ...
                graph[this][another_point] = haversine(data[this][0], data[this][1], data[another_point][0],
